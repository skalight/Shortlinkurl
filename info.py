...
PICS = (environ.get('PICS', 'https://telegra.ph/file/a29cdd9800ec77f8575a3.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001887195187').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+hvGQ4DApC39hYzVl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vibevibevibevibevib')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vibevibevibevibevib')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001680243578')).split()]
...
DOWNLOAD_TEXT_URL = "https://t.me/hugfbhjin"
CAPTION_BUTTON = "Support"
CAPTION_BUTTON_URL = "https://t.me/vibevibevibevibevib"
